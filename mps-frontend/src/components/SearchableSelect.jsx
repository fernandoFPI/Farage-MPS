...
export default function SearchableSelect({
  ...
  return (
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute z-50 mt-1 w-full min-w-[300px] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden">
          {/* Search input */}
